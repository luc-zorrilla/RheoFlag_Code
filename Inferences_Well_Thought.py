...
import numdifftools as nd  # For Hessian
...
class Inference:
    ...
    - Aggregated loss across all ground truths
    - Parallel inference over multiple initial guesses
    """
    ...
    def objective(
        ...
        """
        Aggregated objective function for multiple ground truths.
        ...
        Returns:
            Sum of losses across all ground truths
        """
